...
const ProductCard = ({ item }) => {
    ...
    return (
        <>
            <div className='bg-white rounded-lg hover:bg-green-200 cardShadow group transition-all duration-300 ease-linear h-full flex flex-col mt-5'>
                ...
                <div className="h-[50px] flex flex-col justify-end">
                    {item?.discount_price && <div className="text-[12px] px-2 line-through">
                        ...
                        <Taka tk={item?.regular_price} className={`text-[#d4463c] font-bold`} size={17} />
                    </div>}
                    <div className="">
                        <AddToCart item={item} />
                    </div>
