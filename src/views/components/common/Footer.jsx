                    ...
                    <div className="form-control">
                        <div className="grid grid-cols-1 sm:grid-cols-5 shadow-lg rounded overflow-hidden">
                            <div className="sm:col-span-3">
                                <input type="text" placeholder={bangla ? "সর্বশেষ খবর পান" : "Receive the latest news"} className="input border-none outline-0  focus:border-0 focus:outline-0" />
                            </div>
                            <div className="sm:col-span-2 text-xs">
                                <button className=" border-0 bg-[#50c878] hover:bg-[#1aa749] text-white font-semibold capitalize lg:px-2  px-1 w-full sm:min-w-max h-full">{bangla ? "নিবন্ধন করুন" : "Sign Up"}</button>
                            </div>
                        </div>
                    </div>
                </div>
